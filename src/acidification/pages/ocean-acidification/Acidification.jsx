...
import acercaImg from "../../assets/Acerca_del_tema_acidificacion.png";
import quiz from "../../assets/Quiz_Acidificacion.jpg";
...
import Acido from "../../components/Acidification2.jsx";
...
const Acidification = () => {
  ...
  const handleLearnMoreClick = () => {
    navigate("/Menu/Acidificacion/Info");
  };
        ...
        <main className={`main-content ${isFading ? "fade-out" : "fade-in"}`}>
          ...
          <div className="description-box">
            <p className="description-text">
              La acidificación de los océanos es el resultado de la absorción de
              dióxido de carbono (CO₂) de la atmósfera, lo que aumenta el ácido
              carbónico y reduce el pH del agua. Desde la Revolución Industrial,
              los océanos han absorbido alrededor del 30% del CO₂ emitido,
              disminuyendo el pH en aproximadamente 0.1 unidades.
            </p>

            {showMoreText && (
              <p className="description-text additional-info">
                Este proceso tiene graves consecuencias para la vida marina,
                especialmente para organismos que construyen conchas y
                esqueletos de carbonato de calcio como corales, moluscos y
                algunos tipos de plancton. La acidificación también afecta la
                reproducción y desarrollo de muchas especies marinas, amenazando
                la biodiversidad oceánica y los servicios ecosistémicos que
                proporcionan los océanos.
              </p>
            )}
          ...
          <div className="sections-container">
            ...
            <div className="section-card">
              ...
              <img src={quiz} alt="Quiz imagen" className="section-image" />
